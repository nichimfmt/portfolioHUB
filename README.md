...
Engenharia de Software - Em andamento (1° semestre)
Colégio Leonardo da Vinci
Ensino médio - Conclusão: 2023
Experiência Prática
Desenvolvedor Independente / Estudante (2026 - Presente)
Desenvolvimento de scripts em Python, focados em lógica matemática, incluindo sistemas de verificação de paridade e regras de divisibilidade.
Implementação, estruturação e depuração de códigos utilizando lógicas condicionais.
